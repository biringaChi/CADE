...
First, verify **credential** directory exists, create one if negative and backtrack to **prepoc** directory
```
 $ cd ...;datasets/creddata
 $ if [ ! -d credentials/ ]; then mkdir credentials; else echo "exists"; fi; cd ...; CADE/preproc
```
...
### D <sub>2</sub> : Case Studies (Out-of-Distribution Detection)
[WrongSecrets, Wackopicko, Grueyere, CryptOMG, MCIR]
**TODO**
