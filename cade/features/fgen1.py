...
im_mod = im.util.spec_from_file_location("primps", Path.cwd().parents[0]/"primps.py")
utils, config = im_mod.loader.load_module().import_helper_modules()

primary_path = "/Users/Gabriel/Projects/CADE/datasets/creddata/credentials"
data = utils.reader(primary_path, "auth_key_token.txt")
print(len(data))
